...
<div class="container-fluid m-3">	
    ...
    <div class="col-md-4">
    	...
    	<button class="btn btn-block btn-primary" id="checkout1" type="button">Checkout</button>
<script type="text/javascript">document.getElementById("checkout1").onclick = function(){location.href = "payment.php";}; </script>
    </div>
</div>
</div>
</div>
