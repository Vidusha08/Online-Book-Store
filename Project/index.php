            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                      ...
                      <?php endif; ?>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="Contact us 2.html?page=about">Contact Us</a></li> 
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="about.html?page=about">About Us</a></li>
                        <?php if(isset($_SESSION['login_id'])): ?>
                       <div class=" dropdown mr-4">
                            <a href="#" class="text-white dropdown-toggle"  id="account_settings" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $_SESSION['login_name'] ?> </a>
                              <div class="dropdown-menu" aria-labelledby="account_settings" style="left: -2.5em;">
                                <a class="dropdown-item" href="javascript:void(0)" onclick="window.location.href=payment.php" id="manage_my_account"><i class="fa fa-cog"></i> Manage Account</a>
        ...
        <footer class=" py-3 bg-dark">
			...
			<h5 class="mt-0 text-white">Help</h5>
                    ...
                    <div class="col-lg-3 mr-auto ">
                        ...
                        <div class="text-white"><?php echo $_SESSION['system']['contact'] = "0112456789" ?></div>
                        <!--<i class="fas fa-envelope fa-3x mb-3 text-muted"></i>!-->
                        <!-- Make sure to change the email address in BOTH the anchor text and the link target below!-->
                        <a class="d-block" href="mailto:<?php echo $_SESSION['system']['email'] ?>"><?php echo $_SESSION['system']['email'] = "planet.vibes@gmail.com" ?></a>
            ...
            <div class="container"><div class="small text-center text-muted">Copyright © 2021 - <?php echo $_SESSION['system']['name']="PlanetVibes Online Book Store"; ?>  <a href="https://www.sourcecodester.com/" target="_blank"></a></div></div>
        </footer>
