...
<div class="container-fluid">
	<form action="" id="signup-frm">
		...
		<button class="button " style = "background-color: #007bff"><?php echo !isset($id) ? "Next" : "Update" ?></button>
		<button class="button " style = "background-color: #007bff" type="button" data-dismiss="modal">Cancel</button>
